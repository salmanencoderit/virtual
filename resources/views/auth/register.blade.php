            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="lastname" class="col-md-4 control-label">Hochzeitsdatum</label>

                          <div class="col-md-6">
                              <input type="text" class="form-control datetimepicker" placeholder="Hochzeitsdatum" name="wedding">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                {{ Form::checkbox('is_exhibitor', 1, null, ['class' =>'is_exhibitor']) }}
                                {{ Form::label('is_exhibitor', '&nbsp;Register as Exhibitor')}}
                                {{ $errors->first('is_exhibitor') }}
                            </div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="wedding" class="col-md-4 col-form-label text-md-right">{{ __('Hochzeitsdatum') }}</label>

                            <div class="col-md-6">
                                <input id="wedding" type="text" class="form-control datetimepicker @error('wedding') is-invalid @enderror" name="wedding" value="{{ old('wedding') }}" required>
